...
#### Running with Docker
1. `docker run --name rtorrent-flood -e RTORRENT_SCGI_HOST=w.x.y.z -e RTORRENT_SCGI_PORT=5000 -p 3000:3000 themetabay/flood`
2. Other supported environment variables:
  * `FLOOD_BASE_URI`
  * `FLOOD_SECRET`
  * `RTORRENT_SCGI_HOST`
  * `RTORRENT_SCGI_PORT`
